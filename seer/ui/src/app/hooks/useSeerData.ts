...
export interface SeerDataState {
  // Live data
...
export interface SeerDataActions {
  // Strategy actions
...
export function useSeerData(): SeerDataState & SeerDataActions {
  // State
  ...
  const refreshStrategies = useCallback(async () => {
    try {
      ...
      if (Array.isArray(data)) {
        strategies = data;
      } else if (data && typeof data === 'object' && 'strategies' in data && Array.isArray((data as any).strategies)) {
