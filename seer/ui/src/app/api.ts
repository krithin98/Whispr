// API service for Seer Trading Copilot
...
export const yahooFinance = {
  ...
  async getHistoricalData(symbol: string, startDate: string, endDate: string, interval: string = "1d"): Promise<any> {
    try {
...
export const api = {
  ...
  // Analytics
  async getStrategyTriggersSummary(): Promise<any> {
